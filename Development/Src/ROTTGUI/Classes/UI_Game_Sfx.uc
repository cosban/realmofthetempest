...
defaultProperties
{
  ...
  begin object class=AudioComponent Name=AC_Collect_Glyph
    SoundCue=SoundCue'ROTT_Sound_Effects.ROTT-SFXCUE-Collect_Glyph'
  end object
  ...
  soundEffects[SFX_MENU_BLESS_STAT] = AC_Shrine_Activated
  ...
  soundEffects[SFX_ALCHEMY_COLLECT] = AC_Collect_Glyph
