...
defaultProperties
{
  ...
  skillAttributes.add((attributeSet=COMBAT_ACTION_SET,mechanicType=DECREASE_DODGE_RATING,tag="%dodge",font=DEFAULT_SMALL_ORANGE,returnType=INTEGER));
  
  ///skillAttributes.add((attributeSet=COMBAT_ACTION_SET,mechanicType=HIT_CHANCE_OVERRIDE,tag="%chance",font=DEFAULT_SMALL_WHITE,returnType=INTEGER));
