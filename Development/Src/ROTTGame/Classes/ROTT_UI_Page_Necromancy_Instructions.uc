/*=============================================================================
 * ROTT_UI_Page_Necromancy_Instructions
 *
 * Author: Otay
 * Bramble Gate Studios (All rights reserved)
 *
 * Description: Displays the instructions for the Necromancy mini-game.
 *===========================================================================*/
 
class ROTT_UI_Page_Necromancy_Instructions extends ROTT_UI_Page;
...
public function continueToMenu() {
  ...
  parentScene.pushPageByTag("Page_Necromancy_Menu");
}
...
defaultProperties
{
  ...
  /** ===== Components ===== **/
  // Background
  begin object class=UI_Sprite Name=Necromancy_Instructions_Background
    tag="Necromancy_Instructions_Background"
    posX=0
    posY=0
    images(0)=Instructions_Background
  end object
  componentList.add(Necromancy_Instructions_Background)
  ...
  // 
  begin object class=UI_Label Name=Necromancy_Instruction_Label_H1
    tag="Necromancy_Instruction_Label_H1"
    posX=0
    posY=-124
    posXEnd=NATIVE_WIDTH
    posYEnd=NATIVE_HEIGHT
  ...
  componentList.add(Necromancy_Instruction_Label_H1)
  
  // Instructions line 1
  begin object class=UI_Label Name=Necromancy_Instruction_Label_1
    tag="Necromancy_Instruction_Label_1"
    posX=0
    posY=8
    posXEnd=NATIVE_WIDTH
    posYEnd=NATIVE_HEIGHT
    fontStyle=DEFAULT_MEDIUM_PEACH
    labelText="Battle never-ending enemies"
    alignX=CENTER
    alignY=CENTER
  end object
  componentList.add(Necromancy_Instruction_Label_1)
  
  // Instructions line 2
  begin object class=UI_Label Name=Necromancy_Instruction_Label_2
    tag="Necromancy_Instruction_Label_2"
    posX=0
    posY=128
    posXEnd=NATIVE_WIDTH
    posYEnd=NATIVE_HEIGHT
    fontStyle=DEFAULT_MEDIUM_PEACH
    labelText="for an experience boost."
    alignX=CENTER
    alignY=CENTER
  end object
  componentList.add(Necromancy_Instruction_Label_2)
