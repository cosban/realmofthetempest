/*============================================================================= 
 * ROTT_Inventory_Item_Charm_Shukisu
 *
 * Author: Otay
...
class ROTT_Inventory_Item_Charm_Shukisu extends ROTT_Inventory_Item;
...
defaultProperties
{
  ...
  // Display name
  itemName="Shukisu Charm"
  
  // Item texture
	itemTexture=Texture2D'ROTT_Items.Charms.Item_Charm_Green'
