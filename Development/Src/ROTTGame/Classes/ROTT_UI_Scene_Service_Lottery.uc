...
class ROTT_UI_Scene_Service_Lottery extends ROTT_UI_Scene;
...
defaultProperties 
{
  ...
  begin object class=ROTT_UI_Page_Lottery_Instructions Name=Page_Lottery_Instructions
    tag="Page_Lottery_Instructions"
    bInitialPage=true
  end object
  pageComponents.add(Page_Lottery_Instructions)
  
  // Lottery Menu
  begin object class=ROTT_UI_Page_Lottery_Menu Name=Page_Lottery_Menu
    tag="Page_Lottery_Menu"
  end object
  pageComponents.add(Page_Lottery_Menu)
