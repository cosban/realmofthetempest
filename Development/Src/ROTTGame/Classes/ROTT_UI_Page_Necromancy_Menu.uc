/*=============================================================================
 * ROTT_UI_Page_Necromancy_Menu
 *
 * Author: Otay
 * Bramble Gate Studios (All rights reserved)
 *
 * Description: The menu for using the Necromancy service.
 *===========================================================================*/
 
class ROTT_UI_Page_Necromancy_Menu extends ROTT_UI_Page;
...
defaultProperties
{
  ...
  begin object class=UI_Texture_Info Name=Menu_Background
    componentTextures.add(Texture2D'GUI.Necromancy.Necromancy_Service_Background')
  end object
  
  /** ===== Components ===== **/
  // Background
  begin object class=UI_Sprite Name=Necromancy_Menu_Background
    tag="Necromancy_Menu_Background"
    posX=0
    posY=0
  ...
  componentList.add(Necromancy_Menu_Background)
