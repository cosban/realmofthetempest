/*=============================================================================
 * NPC - Haxlyn Backlands (D)
 *
 * Author: Otay
 * Bramble Gate Studios (All rights reserved)
 *
 * An Backlands NPC in Haxlyn.
 *===========================================================================*/

class ROTT_NPC_Haxlyn_Backlands_D extends ROTT_NPC_Container;
...
defaultProperties
{
  ...
  begin object class=UI_Texture_Info Name=NPC_Sprite
    componentTextures.add(Texture2D'NPCs.Alchemists.NPC_Portrait_Alchemist_Blue_360')
  end object
