/*=============================================================================
 * NPC - Valimor Backlands (B)
 *
 * Author: Otay
 * Bramble Gate Studios (All rights reserved)
 *
 * A backlands NPC in Valimor.
 *===========================================================================*/

class ROTT_NPC_Valimor_Backlands_B extends ROTT_NPC_Container;
...
defaultProperties
{
  ...
  begin object class=UI_Texture_Info Name=NPC_Sprite
    componentTextures.add(Texture2D'NPCs.Alchemists.NPC_Portrait_Alchemist_Purple_360')
  end object
