...
class ROTT_NPC_Haxlyn_Wild_G extends ROTT_NPC_Container;
...
public function initDialogue() {
  ...
  `NEW_NODE(GREETING, NUETRAL)
    "With dust in our wine soaked fists,",
    ""
  `ENDNODE
