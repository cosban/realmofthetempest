...
public function initDialogue() {
  ...
  `NEW_NODE(GREETING, NUETRAL)
    "Is it the way the tempest howls while it berates the walls of my home?",
  ...
  `NEW_NODE(GREETING, NUETRAL)
    "A myriad of ticks and tocks from clicking clocks",
  ...
  `NEW_NODE(GREETING, NUETRAL)
    "Reaching for my quiet marble as it lay resting, was",
