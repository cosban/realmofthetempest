/*=============================================================================
 * ROTT_Combat_Enemy_Okitian_Spirit
 *
 * Lore:
 *  An Okitian spirit has no mouth, because they can communicate entirely with 
 *  their eyes. Matured Okitian spirits have no heart, because when an okitian
 *  spirit matures, they transmute their heart into the spirit of the wind 
 *  around them. Okitian spirits are rarely hostile unless they are protecting
 *  something important.
 *
 * Abilities:
 *  
 *===========================================================================*/
class ROTT_Combat_Enemy_Okitian_Spirit extends ROTT_Combat_Enemy
...
defaultProperties
{
  ...
  // Sprites 240x240
  begin object class=UI_Texture_Info Name=Enemy_Portrait_Okitian_Spirit_Blue_240
  ...
  begin object class=UI_Texture_Storage Name=Enemy_Sprite_Container
    ...
    images(CLAN_BLUE)=Enemy_Portrait_Okitian_Spirit_Blue_240
    images(CLAN_CYAN)=Enemy_Portrait_Okitian_Spirit_Cyan_240
    images(CLAN_GREEN)=Enemy_Portrait_Okitian_Spirit_Green_240
    images(CLAN_GOLD)=Enemy_Portrait_Okitian_Spirit_Gold_240
    images(CLAN_ORANGE)=Enemy_Portrait_Okitian_Spirit_Orange_240
    images(CLAN_RED)=Enemy_Portrait_Okitian_Spirit_Red_240
    images(CLAN_VIOLET)=Enemy_Portrait_Okitian_Spirit_Violet_240
    images(CLAN_PURPLE)=Enemy_Portrait_Okitian_Spirit_Purple_240
    images(CLAN_BLACK)=Enemy_Portrait_Okitian_Spirit_Black_240
    images(CLAN_WHITE)=Enemy_Portrait_Okitian_Spirit_White_240
  end object
  enemySprites=Enemy_Sprite_Container
  
  // Sprites 360x360
  begin object class=UI_Texture_Info Name=Enemy_Portrait_Okitian_Spirit_Blue_360
  ...
  begin object class=UI_Texture_Storage Name=Champ_Sprite_Container
    ...
    images(CLAN_BLUE)=Enemy_Portrait_Okitian_Spirit_Blue_360
    images(CLAN_CYAN)=Enemy_Portrait_Okitian_Spirit_Cyan_360
    images(CLAN_GREEN)=Enemy_Portrait_Okitian_Spirit_Green_360
    images(CLAN_GOLD)=Enemy_Portrait_Okitian_Spirit_Gold_360
    images(CLAN_ORANGE)=Enemy_Portrait_Okitian_Spirit_Orange_360
    images(CLAN_RED)=Enemy_Portrait_Okitian_Spirit_Red_360
    images(CLAN_VIOLET)=Enemy_Portrait_Okitian_Spirit_Violet_360
    images(CLAN_PURPLE)=Enemy_Portrait_Okitian_Spirit_Purple_360
    images(CLAN_BLACK)=Enemy_Portrait_Okitian_Spirit_Black_360
    images(CLAN_WHITE)=Enemy_Portrait_Okitian_Spirit_White_360
  end object
