/*=============================================================================
 * ROTT_Combat_Enemy_Cyclops
 *
 * Lore:
 *  The cyclops are the corrupted minions of the lunar temples.  They are
 *  intelligent and agile.  They practice all kinds of magic, and they summon 
 *  ogres and minotaurs for protection.
 *
 * Ability:
 *  Bloodletter.  The next three attacks will also have DPS.
 *===========================================================================*/
 class ROTT_Combat_Enemy_Cyclops extends ROTT_Combat_Enemy
...
)
{
  ...
  switch (clanColor) {
    ...
    case CLAN_WHITE:
      ...
      statPreferences[PRIMARY_VITALITY] = 15;
...
defaultProperties
{
  ...
  itemDropRates.add((dropType=class'ROTT_Inventory_Item_Herb',chanceOverride=,minOverride=,maxOverride=,chanceAmp=2,quantityAmp=))
