...
class ROTT_NPC_Talonovia_Outskirts_D extends ROTT_NPC_Container;
...
defaultProperties
{
  ...
  begin object class=UI_Texture_Info Name=NPC_Sprite_Texture
    componentTextures.add(Texture2D'NPCs.Merchants.NPC_Portrait_Merchant_Cyan_360')
  end object
