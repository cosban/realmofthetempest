...
class ROTT_NPC_Valimor_Backlands_A extends ROTT_NPC_Container;
...
defaultProperties
{
  ...
  begin object class=UI_Texture_Info Name=NPC_Sprite
    componentTextures.add(Texture2D'NPCs.Merchants.NPC_Portrait_Merchant_Purple_360')
  end object
