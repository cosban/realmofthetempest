...
class ROTT_NPC_Haxlyn_Wild_I extends ROTT_NPC_Container;
...
defaultProperties
{
  ...
  begin object class=UI_Texture_Info Name=NPC_Sprite
    componentTextures.add(Texture2D'NPCs.Merchants.NPC_Portrait_Merchant_Blue_360')
  end object
